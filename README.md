...
- **The destination estate** is the country, region, city, district, landmark, and
  ...
  the reliable backbone and the home of `destination`, `destinations`, and
  `properties`.
...
Records connect into one graph. A suggestion fans into a search, a place, or a
...
its children, and lists its properties. A host can crawl the reachable public
estate from a single seed by following those edges.
